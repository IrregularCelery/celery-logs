...
- **14:35**: Started a new project; HTTP web framework. Probably will be called `WebCel`.
...
- Never mind... I need to re-record the footages... Great! : D : D : D

## March 06, 2025 (Thu)

- **15:10**: Recoreded 40% of `PadPad` project's video.
