...
- Wrote an `Hyprland` implementation for `quickshell` project's `Compositor`.

## November 23, 2025 (Sun)

- Had company, but tried out some different implementations for `Compositor` handling of
  the `quickshell`.

## November 22, 2025 (Sat)

- Created a new service `Logger`, as well as some refactoring of the `quickshell`.

## November 21, 2025 (Fri)

- Created a component (`ScrollIndicator`) and a trait-type-thingy (`Compositor`)
  for the `quickshell` project.

## November 20, 2025 (Thu)

- Back from not being home, too lazy to do shit! hehe : D

## November 19, 2025 (Wed)

- Wasn't home, did absolutely nothing : D

## November 18, 2025 (Tue)

- Did some refactoring and renaming for the `ActionCenter` module of the `quickshell`.
  (See? I listened and commited this in the same day : D)

## November 17, 2025 (Mon)

- Finally backfilled `CeleryLogs` again! I should stop doing this!

## November 16, 2025 (Sun)

- Okay, back to refactoring `quickshell`.

## November 15, 2025 (Sat)

- I started playing `Half Life 1 (Black Mesa)` again!

## November 14, 2025 (Fri)

- Soooo, I binged `Portal 1` and `Poratl 2`! THEY. ARE. AWESOME!!!!! : D

## November 13, 2025 (Thu)

- Refactored some parts of the `quickshell`.

## November 12, 2025 (Wed)

- Created a mockup of `AppLauncher` component for the `quickshell`.

## November 11, 2025 (Tue)

- Wrote a new `FlickableGrid` component for the `quickshell`.

## November 10, 2025 (Mon)

- Started writing some implementations for the `ActionCenter` of the `quickshell`.

## November 9, 2025 (Sun)

- Created a mockup of the `Bar` and `Workspaces` for the `quickshell`.

## November 8, 2025 (Sat)

- So, remember the `ags` setup? I started a `quickshell` one...

## November 7, 2025 (Fri)

- Refactored the `core/store` system and added individual error handling support
  to `Celery Super App`.

## November 6, 2025 (Thu)

- More updates and fixing of the `Celery Super App` according to the new `core/store`.

## November 5, 2025 (Wed)

- Updated existing adapter imlpementations, and fixed some potential bugs for the `Celery Super App`.

## November 4, 2025 (Tue)

- Wrote the implementation for an `IndexedDbAdapter` for the `Celery Super App`.

## November 3, 2025 (Mon)

- Tested out some implementations for an `IndexedDbAdapter` for the `Celery Super App`
  new `core/store` system.

## November 2, 2025 (Sun)

- Completely re-wrote the `core/store` system of the `Celery Super App`! AGAIN! But I really like
  this! I think... : D

## November 1, 2025 (Sat)

- Been trying to find another "best" implementation of the `core/store` of the `Celery Super App`.

## October 31, 2025 (Fri)

- Added some test projects to the `Sandbox` repo. (Related to the `Celery Super App`)

## October 30, 2025 (Thu)

- Created a repo called `Sandbox` that's meant to keep some temporary quickly set up projects
  for easy cloud access.

## October 29, 2025 (Wed)

- Did some changes to some styles of the `Celery Super App`

## October 28, 2025 (Tue)

- Wrote a core system for getting environment values like viewport for the `Celery Super App`.

## October 27, 2025 (Mon)

- Changed something in the `vim` setup! I GUESS!!! : D

## October 26, 2025 (Sun)

- Re-wrote the `core/store` system of the `Celery Super App`.

## October 25, 2025 (Sat)

- Found a new `core/store` system for the `Celery Super App`.

## October 24, 2025 (Fri)

- Been trying out some other ways of writing the `core/store` system of the `Celery Super App`.

## October 23, 2025 (Thu)

- EVEN MORE REFACTORING!!!! POGGG!!! (`Celery Super App`)

## October 22, 2025 (Wed)

- Some more refactoring of the `Celery Super App`.

## October 21, 2025 (Tue)

- Completely nuked my `vim` setup and re-wrote everything from scratch.

## October 20, 2025 (Mon)

- (More) refactoring of the `Celery Super App`.

## October 19, 2025 (Sun)

- Switched the `Celery Super App` package manager to `pnpm`. LOL!

## October 18, 2025 (Sat)

- "Do a whole lotta project restructuring and renaming".

## October 17, 2025 (Fri)

- Wrote a `Dock` component for the `Dev` module of the `Celery Super App` that lists and "manages"
  the dev panels.

## October 16, 2025 (Thu)

- Wrote some parts of the `Dev` module for the `Celery Super App`.

## October 15, 2025 (Wed)

- Wrote some string utility functions for the `Celery Super App`.

## October 14, 2025 (Tue)

- Started writing a system for a visual debugging panel manager for the `Celery Super App`.
  will be called "Dev" module.

## October 13, 2025 (Mon)

- Re-wrote the `ProductTable` of the `Product Comparison` app of the `Celery Super App`. pfff

## October 12, 2025 (Sun)

- Worked on the `Price Comparison` app of the `Celery Super App`

## October 11, 2025 (Sat)

- Wrote a script and a `Vite` plugin for automatically generating tree-shakeable icon components
  from a source for the `Celery Super App`.

## October 10, 2025 (Fri)

- Created an app for comparing products' prices from different suppliers for `Celery Super App`.
  (`Price Comparison`)

## October 9, 2025 (Thu)

- More design testing for the `Celery Super App` project.

## October 8, 2025 (Wed)

- Tested out some values for "fluid design" styling for the `Celery Super App` project.

## October 7, 2025 (Tue)

- Backfilled the `CeleryLogs`.

## October 6, 2025 (Mon)

- Wrote a very simple `Emulator` for the `ISA` of the `CPU` I'm going to be building,
  so I can have a tool to test things out virtually before on the actual hardware.

## October 5, 2025 (Sun)

- Updated my pacman packages! I KNOW! PRODUCTIVE AS FUCK! : D

## October 4, 2025 (Sat)

- Gone out to help my cousin buy a PC. The prices are... absolutely atrocious! Got him:
  - Intel core i5-13400
  - Asus H610M-K R2.0 DDR4
  - Lexar DDR4 16GB single-channel 3200MT/s
  - WD Blue SN5000 512GB NVME M.2
  - 400W generic power supply

## October 3, 2025 (Fri)

- Hmm... finding the best `Table` layout for such thing is hard! (`Celery Super App`)

## October 2, 2025 (Thu)

- Been trying to find the best way to make a nice and responsive `Table`
  for the `Price Comparison` app of the `Celery Super App`.

## October 1, 2025 (Wed)

- Did some stuff like app lazy-loading and shit for the `Celery Super App`.

## September 30, 2025 (Tue)

- ..., So yeah... I went all the way and wrote a framework-typa thing for `Price Comparison` app!
  Let's call it `Celery Super App`. (I know, very creative! : D)
  We can now have multiple apps running within the main `Launcher`.
  Btw, I wrote it using `Svelte`. Don't really like `JS/TS`, but `Svelte` is really cool!

## September 29, 2025 (Mon)

- Umm..., My ADHD wants me to write an app to compare the component prices from different suppliers
  for the `CPU` project... I can't say no to that! : }

## September 28, 2025 (Sun)

- I'll probably go with `74HC` family, I don't know about the `ROM` chips though!
  So many options are unavailable. Might have to go with `EPROMS` for `SRAM` chips! (`CPU` project)

## September 27, 2025 (Sat)

- Watched some more `Homebrew CPU` videos; I also checked out `https://www.homebrewcpuring.org/`
  website! So many cool shit there! : D

## September 26, 2025 (Fri)

- Started researching about the components for the `CPU` project.
  (I'll find a name for the project soon)

## September 25, 2025 (Thu)

- So yeah... I binge-watched a 26 hour playlist by another goat `Fabian Schuiki` on the CPU topic!
  Don't worry about the 26 hours in 24-hour day! It was only 14 hours on 2X : D

## September 24, 2025 (Wed)

- Finally backfilled my `CeleryLogs`. Yay! : D

## September 23, 2025 (Tue)

- So yeah, I kinda wanna make my own `CPU` now...
  and yes, I binge-watched the whole channel of the legend `Ben Eater`.
